...
public class Room {
    ...
    int x, y; /** the position of the bottom left corner of the room  */
    int height, width; /** the height and width of the room, room must be odd-sized */
    int margin; /** the margin of the room*/
    TETile wall; /** Tileset of the wall*/
    TETile floor; /** Tileset of the floor */
    ...
    public static List<Room> generateRooms(Random random,
        ...
        while (retry > 0) {
            ...
            int x = RandomUtils.uniform(random, 0, world[0].length - width);
            int y = RandomUtils.uniform(random,0, world.length - height);
    ...
    public static void main(String[] args) {
        TETile[][] world = new TETile[99][99];
        Random rand = new Random(123);
        List<Room> rooms = generateRooms(rand, 20, world);
